...
#ifndef ALFRED_SWIFT_H
#define ALFRED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Alfred",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Alfred15AlfredViewModel")
@interface AlfredViewModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC6Alfred15AmbientRecorder")
@interface AmbientRecorder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC6Alfred11AudioEngine")
...
@class CLLocation;
SWIFT_CLASS("_TtC6Alfred15LocationManager")
